...
public class SaveCareGUI extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    private void initComponents() {
        ...
        createPatientEmail.setText("craig@gmail.com");
    ...
    private void createAccountBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_createAccountBtnMouseClicked
        ...
        if (pastDateValidation(dateOfBirth) == false) {
            JOptionPane.showMessageDialog(null, "Your The date of birth entered is a future date. Please select a valid date of birth please.");
            return;
        ...
        if (emptyInput(String.valueOf(createPatientSex.getSelectedItem())) == false) {
        ...
        if (user.validateExistingPPSNumber(createPatientPPS.getText()) == false) {
            JOptionPane.showMessageDialog(null, "Invalid PPS Number");
            return;
        }
    ...
    public void createDoctorAccount() {
        try {
            ...
            pstmt.setString(11, createDoctorNumber.getText());
            pstmt.execute();
    ...
    private void initWebcam() {
        ...
        //Sets the preferred size of the webcam 
    ...
    public void loadDateOfBirthYears(JComboBox startBox) {
        ...
        for (int i = year - 14; i > year - 114; i--) {
...
//        System.out.println(String.valueOf(medicationFinishYear.getSelectedItem()));
